...
Route::get('/promise', [HomeController::class,'promise'])->name('promise');
Route::get('/history', [HomeController::class,'history'])->name('history');
Route::get('/tracking', [HomeController::class,'tracking'])->name('tracking');
Route::get('/track-shipment', [HomeController::class,'track_order'])->name('track-shipment');
Route::get('/contact', [HomeController::class,'contact'])->name('contact');
Route::post('/contact', [HomeController::class,'save_contact'])->name('save-contact');
