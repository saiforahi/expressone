                ...
                <div class="col-md-3 col-sm-6 footer-widget">
                    ...
                    <ul class="payment-icons">
                        <li class="wow fadeIn" data-wow-offset="50" data-wow-delay=".20s">
                            <a href="{{route('login')}}" style="background-color: #4f92d7; width: 160px; padding: 13px;border-radius: 15px;text-align: center;
color: white" class="fa fa-play">  Google Play </a>
                        </li>
                        <li class="wow fadeIn" data-wow-offset="50" data-wow-delay=".25s">
                            <a href="{{route('login')}}" style="background-color: #333; width: 160px; padding: 13px;border-radius: 15px;text-align: center;
