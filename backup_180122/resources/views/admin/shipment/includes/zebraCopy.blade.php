<div id="DivIdToPrint" style="box-shadow: 0 0 1in -0.25in rgba(0, 0, 0, 0.5);
    ...
    <div style="width:100%;float:left;border-bottom: 1px solid silver;margin-bottom: 11px;padding:4px;">
        <div style="width:23%;float:left;border-right: 1px solid silver;margin-right: 2%;">
            <img class="logo" style="max-width:100%" src="/images/{{ basic_information()->company_logo }}" />
        </div>
        <div style="width:75%;float:left;">
            <h6 style="margin: 0"><b>Merchant</b>: {{ $shipment->user->first_name }} {{ $shipment->user->last_name }}
            </h6>
            <i>{{ $shipment->user->address }}</i> <br>
            <h6 style="margin: 0">{{ $shipment->user->phone }}</h6>
        </div>
    </div>
    <hr style="border-bottom:1px solid; margin:5px 0px">
    ...
    <div
        style="width:100%;float:left;margin-bottom: 11px;padding:4px;border-bottom:1px solid silver; margin-bottom:10px">
