            ...
            <div class="row">
                <div class="x_panel">
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-4">
                                <img style="height: 100px" class="img-thumbnail img-fluid"
                                    src="{{ $user->image == null ? asset('images/user.png') : asset('storage/user/' . $user->image) }}">
                            </div>
                            <div class="col-md-8">
                                Merchant ID: {{ $user['merchant_id'] }} <br>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                {{-- @if ($user->area_id != null)
                                    ...
                                    Area: <span class="text-danger">Not set</span>
                                @endif --}}
                                <br>
                                ...
                                @else <a target="_blank" class="label label-success">{{ $user->website_link }}</a>
                                @endif <br>
                            </div>
                            <div class="col-md-6">
                                ...
                                @else <span class="label label-danger">Block</span>
                                @endif <br>
                                    ...
                                    @foreach ($shipments as $key => $shipment)
                                        <tr>
                                            <th scope="row">
                                                ...
                                                Tracking code: <a href="/tracking?code={{ $shipment->tracking_code }}"
                                                    target="_blank">{{ $shipment->tracking_code }}</a> <br>
                                                Status:
                                            ...
                                            <th scope="row">
                                                ...
                                                Pickup location: {{ $shipment->pickup_location->name }} <br>
