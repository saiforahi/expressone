                        ...
                        <div class="quote_form">
                            ...
                            <form class="row" action="{{ route('register.store') }}" method="post">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <textarea class="form-control" name="address" cols="30" rows="1"></textarea>
                                </div>
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" value="{{ old('id_value') }}" class="form-control"
                                                placeholder="Enter valid identification number" name="id_value">
                                            @error('id_value')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
