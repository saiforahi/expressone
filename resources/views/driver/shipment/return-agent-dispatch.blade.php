                            ...
                            @foreach($paracels as $key=>$row)
                                <tr><td>{{$key+1}}</td>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <button class="btn btn-success btn-sm report" data-id="{{$row->id}}">Delivery Report</button>
        ...
        <div class="modal-body">
            <form class="row" method="post" action="{{route('return-shipment-delivery')}}">@csrf
                ...
                <div class="col-md-12" style="margin-top:1em">
                    ...
                    <button class="btn btn-sm btn-info pull-right" style="submit"><i class="fa fa-send"></i> Submit Report</button>
                </div>
            </form>
        </div>
      </div>
