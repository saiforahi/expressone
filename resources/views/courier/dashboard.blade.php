                    ...
                    <div class="x_content">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item @if ($type == 'delivery')active @endif">
                                <a class="nav-link" href="/courier?r=delivery">All Delivery</a>
                            </li>
                            <li class="nav-item">
                                            ...
                                            <div class="input-prepend input-group">
                                                ...
                                                <div class="form-control">
                                                    <label class="radio-inline"><input type="radio" name="type"
                                                            value="delivery">Delivery Shipment</label>
                                                    <label class="radio-inline"><input type="radio" name="type"
                                                            value="pickup">Pickup Shipments</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <button class="btn btn-primary form-control" id="GoSearch"><i
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="/courier/confirm-otp">@csrf
                    <div class="control-group ">
                        <div class="controls row">
    ...
    <script>
        ...
        $(function() {
            ...
            let table = $('#datatable').DataTable({
                ...
                serverSide: true,
                ajax: "/courier/get-shipments/<?php echo $type; ?>",
                order: [
                    [0, 'desc']
                ],
                columns: [{
            ...
            $('#GoSearch').on('click', function() {
                ...
                if ($('[name=type]').is(':checked') === false) {
                    alert('Please check a shipment type & proceed!!');
                    return false;
                }
                ...
                $.ajax({
                    type: 'get',
                    url: '/courier/get-shipments-with-dates/' + newDates + '/' + type,
