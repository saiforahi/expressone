                ...
                <ul class="nav side-menu">
                    ...
                    <li><a><i class="fa fa-money"></i> Shipping Price <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            ...
                            <li><a href="{{route('shippingPrice.set')}}">Price rate set</a></li> @endif
                        </ul>
                    </li>

                    @if(checkAdminAccess('all-shipments') != 0 )
                    <li><a href="{{route('all-shipments')}}"><i class="fa mdi mdi-export"></i> All shipments</a></li> @endif

                    <li><a><i class="fa mdi mdi-cube-send"></i> Logistics <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            @if(checkAdminAccess('shipping-list') != 0 )
                            <li><a href="{{route('AdminShipment.index')}}">Pick-up</a></li> @endif

                            @if(checkAdminAccess('shipping-list/received') != 0 )
                            <li><a href="{{route('AdminShipmentReceived')}}">Receive</a></li> @endif

                            @if(checkAdminAccess('shipping-list/dispatch') != 0 )
                            <li><a href="{{route('AdminShipmentDispatch')}}">Dispatch</a></li> @endif

                            @if(checkAdminAccess('agent-dispatch') != 0 )
                            <li><a href="{{route('AdminAgentDispatch')}}">Agent Dispatch</a></li> @endif

                            @if(checkAdminAccess('reconcile') != 0 )
                            <li><a href="{{route('AdminReconcile')}}">Reconcile</a></li> @endif

                            @if(checkAdminAccess('delivery') != 0 )
                            <li><a href="{{route('AdminDelivery')}}">Delivery</a></li> @endif
                    ...
                    <li><a href="{{route('driver-list.index')}} "><i class="fa mdi mdi-truck-fast"></i> Riders</a> </li>
                    ...
                    <li><a><i class="fa fa-home"></i> Website Management <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            ...
                            <li><a href="{{route('adminAbout')}}">About Us page</a></li> @endif

                            @if(checkAdminAccess('mission') != 0 )
                            <li><a href="{{route('adminMission')}}">Mission page</a></li> @endif

                            @if(checkAdminAccess('vision') != 0 )
                            <li><a href="{{route('adminVision')}}">Vision page</a></li> @endif

                            @if(checkAdminAccess('promise') != 0 )
                            <li><a href="{{route('adminPromise')}}">Our Promise page</a></li> @endif

                            @if(checkAdminAccess('history') != 0 )
                            <li><a href="{{route('adminHistory')}}">Company History page</a></li> @endif

                            @if(checkAdminAccess('team') != 0 )
                            <li><a href="{{route('adminTeam')}}">Management Team page</a></li> @endif

                            @if(checkAdminAccess('client-reviews') != 0 )
                            <li><a href="{{route('adminClientReview')}}">Client Reviews</a></li> @endif

                            @if(checkAdminAccess('messages') != 0 )
                            <li><a href="{{route('contact-messages')}} ">Contact Messages</a></li> @endif

                            <li><a> Blogs <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" style="display: none;">
                                    @if(checkAdminAccess('blog/index') != 0 )
                                    <li><a href="{{route('AdminBlog')}} ">Blog Posts</a> </li> @endif

                                    @if(checkAdminAccess('blog/category') != 0 )
                                    <li><a href="{{route('blog-category')}}">Blog Category</a> </li> @endif
                                </ul>
                            </li>
                        </ul>
                    </li>
