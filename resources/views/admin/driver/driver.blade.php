                                        ...
                                        <tr>
                                            ...
                                            <th scope="row" class="text-right">
                                                <div class="btn-group  btn-group-sm">
                                                    <form action="{{ route('courierDelete', $drivers->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        ...
                                                        <a class="btn btn-info"
                                                            href="/admin/courier-shipments/{{ $drivers->id }}">Shipments</a>
                                                    </form>
                                                </div>
                                            </th>
                                        </tr>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br>
                            <form id="demo-form2" method="post" action="{{ route('addEditCourier') }}"
