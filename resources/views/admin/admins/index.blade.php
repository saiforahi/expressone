        ...
        <div class="page-title">
            ...
            <div class="title_right">
                <div class="col-md-12 col-sm-12 form-group top_search">
                    <button data-toggle="modal" data-target=".add_employee" type="button"
    ...
    <div class="modal fade edit_employee" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('update-admin') }}" id="edit_employee" method="post"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#employee_form').on('submit', function(event) {
                ...
                $("[type='submit']").html(
                    '<i class="fa fa-spinner fa-pulse fa-spin fa-fw"></i><span class="sr-only"></span> Loading...'
                );
