                    ...
                    <div class="x_content">
                        ...
                        <form id="demo-form2" method="post" action="{{ route('merchant.store') }}" autocomplete="off" class="form-horizontal form-label-left input_mask"> @csrf
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                ...
                                <input type="text" class="form-control" placeholder="Ahmed" name="last_name" id="last_name" value="{{ old('last_name') }}">
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                <label for="email">Email:</label>
                                <input type="text" class="form-control" placeholder="abc@gmail.com" name="email" id="email" value="{{ old('email') }}">
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                <label for="phone">Phone:</label>
                                <input type="text" class="form-control" placeholder="01234567898" name="phone" id="phone" value="{{ old('phone') }}">
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                ...
                                <input type="text" class="form-control" placeholder="Mirpur, dhaka, bangladesh.." name="address" id="address" value="{{ old('address') }}">
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                <label for="website_link">Page / Website Link:</label>
                                <input type="text" class="form-control" placeholder="http://www.xyz.com" name="website_link" id="website_link" value="{{ old('website_link') }}">
                            </div>
                            <div class="col-md-12 form-group has-feedback ">
                                <button type="submit" class="btn btn-success pull-right"><i class="mdi mdi-content-save m-r-3"></i>Save
                                </button>
                    ...
                    <div class="x_content">
                        ...
                        <form id="demo-form2" method="post" class="form-horizontal form-label-left input_mask" action="/admin/add-parcelBy-admin"> @csrf
                            ...
                            <div class="row"> <br>
                                ...
                                <div class="col-md-10">
                                    <label class="radio-inline"><input type="radio" value="0" name="status" checked>Label create (pickup)</label>
