...
<head>
    <title>parcels for {{ $hub->name . ' - ' . date('y-m-d h:i:s') }}</title>
</head>
...
<body>
    ...
    @foreach ($shipment_ids as $key => $id)
        ...
        <table class="table table-hover table-bordered">
            ...
            <tr>
                <td style="width:20%">Merchant info: </td>
                <td>{{ $shipment->user->first_name }} {{ $shipment->user->last_name }} - {{ $shipment->user->phone }}
                </td>
            </tr>
            <tr>
    ...
    <table class="table table-hover table-bordered">
        <tr>
            <th>Total Price with shiping</th>
            <th>{{ array_sum($total_price) }}</th>
        </tr>
    </table>
