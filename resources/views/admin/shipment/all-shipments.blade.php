                            ...
                            <tbody>
                                @foreach ($shipments as $shipment)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{-- @if (!empty($shipment->pickup_location_id))
                                                Name
                                            @else
                                               Pickup location not set by Merchant
                                            @endif --}}
                                        ...
                                        <td>@include('admin.shipment.status',['status'=>$shipment->status,'shipping_status'=>$shipment->shipping_status])
                                        </td>
                                        <td class="text-right">
                                            <button class="btn btn-xs btn-warning reset"
                                                id="{{ $shipment->id }}">Reset</button>
                ...
                <div class="modal-body">
                    ...
                    <option value="5">Out for delivery</option> --}}
                            ...
                            <div class="col-md-4 col-sm-4">
                                <button class="btn btn-info" type="submit"><i class="fa fa-undo"></i> Reset
                                    Shipment</button>
                            </div>
    ...
    <script>
        $(function() {
            $('[name=zone_id]').on('change', function() {
                ...
                $.ajax({
                    type: "get",
                    url: '/admin/zone-to-area/' + zone_id,
