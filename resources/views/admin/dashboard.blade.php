            ...
            <div class="col-md-6 ">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <strong>{{ sprintf('%02d', $todayShop) }}</strong><br>
                                <p>Shop onboarded, today</p>
                            </div>
                            <div class="col-md-4">
                                <?php $yesterdayShop = \DB::table('users')
                                    ->whereDate('created_at', \Carbon\Carbon::yesterday())
                                    ->count(); ?>
                                <strong>{{ sprintf('%02d', $yesterdayShop) }}</strong><br>
                                <p>Shop onboarded, yesterday</p>
                            </div>
                            <div class="col-md-4">
                                <?php $dayBefore7 = \Carbon\Carbon::today()->subDays(7);
                                $shop7 = \DB::table('users')
                                    ->where('created_at', '>=', $dayBefore7)
                                    ->count(); ?>
                                <strong>{{ sprintf('%02d', $shop7) }}</strong><br>
                                <p>Shop onboarded, last 7 days</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 ">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <?php $ordersToday = \DB::table('shipments')
                                    ->whereDate('created_at', \Carbon\Carbon::today())
                                    ->count(); ?>
                                <strong>{{ sprintf('%02d', $ordersToday) }}</strong><br>
                                <p>Orders, today</p>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <?php $orderYesterday = \DB::table('shipments')
                                    ->whereDate('created_at', \Carbon\Carbon::yesterday())
                                    ->count(); ?>
