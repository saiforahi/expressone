    ...
    <div class="tab-content">
        ...
        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
            <div class="main-card mb-3 card card-body">
                <form id="upload_form" method="post"> {{csrf_field()}}
                        ...
                        <div class="col text-left">
                            ...
                            <select class="form-control select2" name="area" id="area">
                                ...
                                @foreach($area as $areas)
                                        <option @if($shipment->area_id==$areas->id)selected @endif value="{{$areas->id}}">{{$areas->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-row my-4">
                        <div class="col text-left">
                            ...
                            <input type="text" id="weight" class="form-control" name="weight"  value="{{$shipment->weight}}">
                            <div class="w-100">
                        ...
                        <div class="col cod_target text-left">
                            ...
                            <input type="number" id="parcel_value" class="form-control" name="parcel_value"  value="{{$shipment->parcel_value}}">
                            <div class="w-100">
                        ...
                        <div class="col text-left">
                            ...
                            <input type="text" id="invoice_id" class="form-control" name="invoice_id" value="{{$shipment->invoice_id}}">
                        </div>
                    </div>
                    <div class="form-row my-4">
                        <div class="col text-left">
                    ...
                    <div class="form-row my-4">
                        <div class="col text-left">
                            ...
                            <div class="form-check form-check-inline">
                              <input class="form-check-input" type="radio" checked name="delivery_type" id="inlineRadio1" value="1" @if($shipment->delivery_type=='1')checked @endif />
                              <label class="form-check-label" for="inlineRadio1">Regular</label>
                            </div>
                            <div class="form-check form-check-inline">
                              <input class="form-check-input" type="radio" name="delivery_type" id="inlineRadio2" value="2" @if($shipment->delivery_type=='2')checked @endif />
                              <label class="form-check-label" for="inlineRadio2">Express</label>
                            </div>
                        </div>
                        <div class="col text-right">
                            <button type="submit" id="submit_button" class="btn btn-success rounded my-4"> <i class="fa fa-edit"></i> Save the Change
                                </button>
                        </div>
                    </div>
