    ...
    <div id="invoice-POS">
        <center id="top">
            <div class="info" style="box-sizing: border-box;">
                <div class="row m-auto" style="margin-left: 110px !important;">
                    {{QrCode::size(150)->generate($shipment->tracking_code)}}
                </div>
                {{-- <div class="row tracking_code" style="margin-left: 85px !important;">
...
<div style="display: none; !important" id="DivIdToPrint">
    <div id="invoice-POS">
        <center id="top">
            <div class="info" style="box-sizing: border-box;">
