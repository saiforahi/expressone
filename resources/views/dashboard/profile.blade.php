        ...
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                <div class="page-title-icon" style="width: 87px;height: 87px;padding: 0px">
                    <img src="{{ Auth::guard('user')->user()->image == null ? asset('images/user.png') : asset('storage/user/' . Auth::guard('user')->user()->image) }}"
                        id="previewLogo" width="100%" height="100%" class="border p-1">
                </div>
            ...
            <div class="page-title-actions">
                <div class="d-inline-block dropdown">
                    <button type="button" onclick="location.href='{{ route('ProfileEdit') }}';"
                    ...
                    <table class="mb-0 table table-hover">
                        <tbody>
                            <tr>
                                ...
                                <td>{{ Auth::guard('user')->user()->first_name . ' ' . Auth::guard('user')->user()->last_name }}
                                </td>
                            </tr>
                            <tr>
                                <td>Shop Name:</td>
                            ...
                            <tr>
                                <td>{{ Auth::guard('user')->user()->id_type }}-No</td>
                                <td><button
                                        class="btn btn-primary">{{ Auth::guard('user')->user()->id_value }}</button>
                                </td>
                            </tr>
                            <tr>
                                <td>Bank:</td>
